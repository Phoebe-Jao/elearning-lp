const Form = () => {
  return (
    <form className="flex flex-col gap-3 py-10 w-full max-w-4/5 mx-auto">
      <div className="flex gap-2">
        <input type="text" name="Name" id="" placeholder="Name" className="form-input outline-0" required />
        <input type="text" name="Email" id="" placeholder="Email" className="form-input outline-0" required />
      </div>
